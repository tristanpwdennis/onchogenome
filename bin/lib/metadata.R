...
#get og sample data
  sampdata <- read.csv('/Users/tristanpwdennis/Projects/onchogenome/metadata/sample_sets/og_uhb_dec_2018.csv')
  #get table specifying bam order
  bamorder <- read.csv('/Users/tristanpwdennis/Projects/onchogenome/metadata/bamlist.csv')
  bamorder <- bamorder %>% select(sample_id, sample_num)
  
  #concatenate sequencing plates
  concat <- rbind(read.csv('/Users/tristanpwdennis/Projects/onchogenome/metadata/sequencing_plates/WS_08_19_MALES.csv', stringsAsFactors = FALSE), 
                  read.csv('/Users/tristanpwdennis/Projects/onchogenome/metadata/sequencing_plates/WS_08_19_MF.csv', stringsAsFactors = FALSE), 
                  read.csv('/Users/tristanpwdennis/Projects/onchogenome/metadata/sequencing_plates/WS_11_19_MF.csv', stringsAsFactors = FALSE))
